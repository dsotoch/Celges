...
class EditCompraRequest extends FormRequest
{
    ...
    {
        $compraId = $this->route('id');

        return [
            'numero' => [
                'required',
                Rule::unique('compras', 'numero')->ignore($compraId),
            ],
            ...
            'numero_documento' => [
                'required',
                Rule::unique('compras', 'numero_documento')->ignore($compraId),
            ],
    ...
    public function messages()
    {
        return [
            ...
            'estado.in' => 'El estado debe ser PENDIENTE o PAGADO - ANULADO.',
        ];
    }
